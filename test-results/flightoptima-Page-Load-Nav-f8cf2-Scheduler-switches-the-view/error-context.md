...
- Name: flightoptima.spec.js >> Page Load & Navigation >> clicking Pilot Scheduler switches the view
- Location: flightoptima.spec.js:39:3
...
Locator: locator('text=Pilot Scheduler')
Expected: visible
Error: strict mode violation: locator('text=Pilot Scheduler') resolved to 3 elements:
    1) <button class="nav-btn active">…</button> aka getByRole('button', { name: 'Pilot Scheduler' })
    2) <h2>…</h2> aka getByRole('heading', { name: 'Multi-Day Pilot Scheduler' })
    3) <p>Generate multi-day flights and run pilot schedule…</p> aka getByText('Generate multi-day flights and run pilot scheduler to see assignments')

Call log:
  - Expect "toBeVisible" with timeout 5000ms
  - waiting for locator('text=Pilot Scheduler')
...
- generic [ref=e3]:
  - banner [ref=e4]:
    ...
    - navigation [ref=e9]:
      ...
      - button "Pilot Scheduler" [active] [ref=e18] [cursor=pointer]:
        - img [ref=e19]
  ...
  - main [ref=e29]:
    - complementary [ref=e30]:
      ...
      - generic [ref=e53]:
        - heading "Multi-Day Pilot Scheduler" [level=2] [ref=e54]:
          - img [ref=e55]
          - text: Multi-Day Pilot Scheduler
        - generic [ref=e60]:
          - generic [ref=e61]: "Number of Pilots: 5"
          - slider [ref=e62]: "5"
        - generic [ref=e63]:
          - generic [ref=e64]: Scheduling Strategy
          - combobox [ref=e65]:
            - option "Least Busy (Fair Distribution) ⭐" [selected]
            - option "Most Available (Max Utilization)"
            - option "Round Robin (Equal Assignments)"
        - generic [ref=e66]:
          - generic [ref=e67]: "Min Rest Hours: 10h"
          - slider [ref=e68]: "10"
          - text: "FAA minimum: 10 hours"
        - generic [ref=e69]:
          - generic [ref=e70]: "Max Daily Hours: 8h"
          - slider [ref=e71]: "8"
          - text: "FAA maximum: 8 hours"
        - button "Generate Flights First" [disabled] [ref=e72]:
          - img [ref=e73]
          - text: Generate Flights First
        - paragraph [ref=e75]: 💡 Generate multi-day flights first
    - paragraph [ref=e78]: Generate multi-day flights and run pilot scheduler to see assignments
```
