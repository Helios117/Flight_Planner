...
- Name: flightoptima.spec.js >> Route Planner >> Full Demo section is visible
- Location: flightoptima.spec.js:119:3
...
Locator: locator('text=Full Demo')
Expected: visible
Error: strict mode violation: locator('text=Full Demo') resolved to 2 elements:
    1) <h2>…</h2> aka getByRole('heading', { name: 'Full Demo' })
    2) <button class="btn btn-secondary">…</button> aka getByRole('button', { name: 'Run Full Demo' })

Call log:
  - Expect "toBeVisible" with timeout 5000ms
  - waiting for locator('text=Full Demo')
