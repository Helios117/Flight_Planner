...
- Name: flightoptima.spec.js >> Route Planner >> selecting different source and destination and clicking Find Shortest Route shows result
- Location: flightoptima.spec.js:92:3
...
Locator: locator('text=Distance').first()
Expected: visible
Timeout: 6000ms
...
Call log:
  ...
  - waiting for locator('text=Distance').first()
...
- main:
  - complementary:
    ...
    - combobox:
      ...
      - option "AMS - Amsterdam Schiphol"
      - option "ATL - Hartsfield-Jackson Atlanta" [selected]
      - option "BOS - Boston Logan International"
      - option "CDG - Paris Charles de Gaulle"
      - option "DEN - Denver International"
      - option "DFW - Dallas/Fort Worth International"
    ...
    - button "Run Full Demo":
      ...
      - text: Run Full Demo
    - img
    - text: Please select source and destination
  - button
  - button
  - button
  - button
